...
xst -ifn xst.scr
move cmtmod_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\cmtmod_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc cmtmod_exdes.ucf cmtmod_exdes

echo 'Running map'
map -timing -pr b cmtmod_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm cmtmod_exdes -w routed.ncd routed.v
cd ..
